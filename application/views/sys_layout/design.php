...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" href="<?=site_url('assets/css/design.css')?>" media="screen" title="no title" charset="utf-8" />
	...
	<body>
		<?php $this->load->view('sys_layout/design/header')?>
		<section class="container">
		<?php $this->load->view($sys_my_content_view)?>
		</section>
		<?php $this->load->view('sys_layout/design/footer')?>
